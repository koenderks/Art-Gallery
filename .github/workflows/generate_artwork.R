...
artwork <- switch(type,
  ...
  "34" = canvas_lissajous(colors = colorPalette("random-palette"), background = sample(c("#fafafa", "firebrick", "#f9f0e0", "black", "lavenderblush2", "#215682"), 1), iterations = sample(2:5, size = 1))
)
